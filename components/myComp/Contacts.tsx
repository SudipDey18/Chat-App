...
const Contacts = () => {
  ...
  const renderContact = ({ item }: { item: Contact }) => {
    ...
    const handelClickContact = async () => {
      setRoom({
        reciverId: participant[0]._id,
        roomId: item._id,
        reciverName: item.participants[0].name,
        publicKey: item.participants[0].publicKey,
      });
    ...
    return (
      <TouchableOpacity style={styles.contactItem} onPress={handelClickContact}>
        <Image
          source={{
            uri: `https://api.dicebear.com/10.x/adventurer-neutral/png?seed=${participant[0].name}`,
          }}
          style={styles.avatar}
        />
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        >
          <Image
            source={{
              uri: `https://api.dicebear.com/10.x/adventurer-neutral/png?seed=${loginUserName}`,
            }}
